...
class DeveloperPreview{
    ...
    let state1 = StatisticModel(title: "Market Cap", value: "$12.8 Bn", percentageChange: 25.34)
    let state2 = StatisticModel(title: "Total volume", value: "$1.23 Tr")
    let state3 = StatisticModel(title: "Portfolio Value", value: "$50.4k", percentageChange: -12.34)
    let coin = CoinModel(id: "bitcoin", symbol: "btc",
                       name: "Bitcoin",
